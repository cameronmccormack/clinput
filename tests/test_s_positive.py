...
class TestPositive:
    ...
    def test_one_false(self):
        ...
        sys.stdin = StringIO("1")
        sys.stdout = StringIO()
        value = positive("Enter: ", zero=False)
        assert sys.stdout.getvalue() == "Enter: "
        assert value == 1.0
        assert type(value) is float
    ...
    def test_zero_false(self):
        ...
        sys.stdout = StringIO()
        value = positive("Enter: ", zero=False)
        assert sys.stdout.getvalue() == ("Enter: Please enter a positive "
                                         "number.\nEnter: ")
        assert value == 1.0
        assert type(value) is float
    ...
    def test_custom_msg(self):
        ...
        sys.stdin = StringIO("spam\n1")  # last input 1 to break input loop
        sys.stdout = StringIO()
        value = positive("Enter: ", err="No, not that!")
